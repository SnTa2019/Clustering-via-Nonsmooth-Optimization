...
c Results: Objective function value, CPU time, DB index,  
c number of misclassified points & value of total misclassification cost 
c=====================================================================
      PARAMETER(maxdim=4000, maxrec=50000, maxclust=15, maxnft=50,
...
c========================================================================
      ...
      PRINT *,'Version?'
      PRINT *,' '
      PRINT *,'      1 - only clustering (Phase 1)'
      PRINT *,'      2 - new model (Phases 1 & 2)'
      read *,nversion
      PRINT *,' '
c===================================================================
      tau1=9.0d-01
...
c================================================================
       WRITE(42,*)
       WRITE(42,701)
 701   FORMAT('#Clust','               Objective_val','          CPU',
     1 '                         DBI'
     1 '             Cost fun', '               #missclass_point')
       WRITE(42,*) 
       write(42,*) '*************************************************'
...
c===================================================================
      if(nc.gt.1) then
       write(42,499) nc,f,time4,db,pen,nneg
      end if  
 499  format(i6,f28.4,f15.3,f28.4,f20.4,i20)     
...
c====================================================================
c Phase1: Compactness starts here
c====================================================================
...
c=========================================================================
      ...
      PARAMETER(maxdim=4000, maxrec=50000, maxnft=50)
      implicit double precision (a-h,o-z)
      double precision x(maxdim),a(maxrec,maxnft)
...
c=========================================================================
      ...
      implicit double precision (a-h,o-z)
      PARAMETER(maxvar=4000, maxrec=50000, maxclust=15, maxnft=50)
...
c=======================================================================
c Phase2: Separability  starts here
c=======================================================================
...
c=====================================================================
      ...
      implicit double precision (a-h,o-z)
      PARAMETER(maxvar=4000, maxrec=50000, maxclust=15)
...
c==================================================================
      ...
      PARAMETER(maxrec=50000, maxclust=15, maxnft=50)
      implicit double precision(a-h,o-z)
